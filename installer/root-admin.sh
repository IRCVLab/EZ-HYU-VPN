...
APP_SUPPORT="$(map_path '/Library/Application Support/HYU VPN')"; HELPER_DST="$(map_path /Library/PrivilegedHelperTools/com.hyu.vpn.helper)"; SUDOERS_DST="$(map_path /etc/sudoers.d/hyu-vpn)"; APP_DST="$(map_path '/Applications/HYU VPN.app')"
